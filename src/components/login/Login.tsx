import { useCustomLogin } from '../../common/hooks/useCustomLogin.hook';
...
export const Login = () => {
    ...
    async function loginFunc(values: LoginFormValues) {
        ...
        const result = await login('/api/staff/login', {
        ...
        if (!result.success && result.msg) {
            ...
            const errorData = result.msg.response?.data as any;
            if (errorData?.key) {
                switch (errorData.key as string) {
